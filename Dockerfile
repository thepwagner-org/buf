FROM golang:1.20.0@sha256:53b7958a2fb14e80163fac58a29bf5bf56b3f9bf85ffb981619c1f2da57e896c AS protoc-gen-go
RUN mkdir /app
WORKDIR /app
COPY go.mod .
COPY go.sum .
...
ARG BUF_VERSION=v1.13.1
ARG BUF_CHECKSUM=891961b6f800d1d99dcef0a89b0247002643f961b26940448ada6a6d90795cad
...
FROM gcr.io/distroless/static-debian11:latest@sha256:450981e797a3da56ef2edf42691fc21db464c2bb351e60bcccb08aed2d49ef83
