FROM golang:1.22.1@sha256:282dd13829064569118c9bb3378808129948564abd2ed0dcd8640789d4984c92 AS protoc-gen-go
RUN mkdir /app
WORKDIR /app
COPY go.mod .
COPY go.sum .
...
ARG BUF_CHECKSUM=bc39722fbdc0e153a1be8f2c525610be277628fd1178d51f37eedab4cc0d10c5
...
FROM gcr.io/distroless/static-debian11:latest@sha256:7e5c6a2a4ae854242874d36171b31d26e0539c98fc6080f942f16b03e82851ab
