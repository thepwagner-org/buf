FROM golang:1.20.6@sha256:cfc9d1b07b1ef4f7a4571f0b60a99646a92ef76adb7d9943f4cb7b606c6554e2 AS protoc-gen-go
RUN mkdir /app
WORKDIR /app
COPY go.mod .
COPY go.sum .
...
ARG BUF_VERSION=v1.24.0
ARG BUF_CHECKSUM=cdcf0952cb6110edb75f3e629da59de43f01ffe2c41cad3942339d46630a425c
