FROM golang:1.22.4@sha256:4950c1cce16bb754e23ee70d25a67e906149d0faedc0aaeed49c075b696fa889 AS protoc-gen-go
RUN mkdir /app
WORKDIR /app
COPY go.mod .
COPY go.sum .
...
ARG BUF_VERSION=v1.33.0
ARG BUF_CHECKSUM=13424d8aae29460cf01c8aaeafc6b0f8819a25e3102473dd7e22879288991724
