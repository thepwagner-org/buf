FROM golang:1.20.2@sha256:f7099345b8e4a93c62dc5102e7eb19a9cdbad12e7e322644eeaba355d70e616d AS protoc-gen-go
RUN mkdir /app
WORKDIR /app
COPY go.mod .
COPY go.sum .
...
FROM gcr.io/distroless/static-debian11:latest@sha256:97b762efb017cbbabf566046852de8049f84f73e168282d06da316851c7ef263
