FROM golang:1.21.0@sha256:a0e3e6859220ee48340c5926794ce87a891a1abb51530573c694317bf8f72543 AS protoc-gen-go
RUN mkdir /app
WORKDIR /app
COPY go.mod .
COPY go.sum .
...
ARG BUF_VERSION=v1.26.0
ARG BUF_CHECKSUM=7065971a67126ec6cfc23490b43113ef2578372eced2b768efc9a185786d9896
